...
func (x *ShipmentEvent) GetComment() string {
	if x != nil {
		return x.Comment
	}
	return ""
...
const file_shipment_v1_shipment_proto_rawDesc = "" +
	"\n" +
	"\x1ashipment/v1/shipment.proto\x12\vshipment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x03\n" +
	"\bShipment\x12\x0e\n" +
	...
	"\bshipment\x18\x01 \x01(\v2\x15.shipment.v1.ShipmentR\bshipment\"\x16\n" +
	"\x14ListShipmentsRequest\"L\n" +
	"\x15ListShipmentsResponse\x123\n" +
	"\tshipments\x18\x01 \x03(\v2\x15.shipment.v1.ShipmentR\tshipments\"\x89\x01\n" +
	...
	"\x19SHIPMENT_STATUS_CANCELLED\x10\x052\xdb\x03\n" +
	...
	"\rListShipments\x12!.shipment.v1.ListShipmentsRequest\x1a\".shipment.v1.ListShipmentsResponse\x12_\n" +
	"\x10AddShipmentEvent\x12$.shipment.v1.AddShipmentEventRequest\x1a%.shipment.v1.AddShipmentEventResponse\x12b\n" +
	"\x11GetShipmentEvents\x12%.shipment.v1.GetShipmentEventsRequest\x1a&.shipment.v1.GetShipmentEventsResponseB!Z\x1fgithub.com/FIFSAK/TMS/pkg/pb;pbb\x06proto3"
...
var file_shipment_v1_shipment_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_shipment_v1_shipment_proto_goTypes = []any{
	...
	(*ListShipmentsRequest)(nil),      // 7: shipment.v1.ListShipmentsRequest
	(*ListShipmentsResponse)(nil),     // 8: shipment.v1.ListShipmentsResponse
	(*AddShipmentEventRequest)(nil),   // 9: shipment.v1.AddShipmentEventRequest
	(*AddShipmentEventResponse)(nil),  // 10: shipment.v1.AddShipmentEventResponse
	(*GetShipmentEventsRequest)(nil),  // 11: shipment.v1.GetShipmentEventsRequest
	(*GetShipmentEventsResponse)(nil), // 12: shipment.v1.GetShipmentEventsResponse
...
var file_shipment_v1_shipment_proto_depIdxs = []int32{
	...
	13, // 1: shipment.v1.Shipment.created_at:type_name -> google.protobuf.Timestamp
	13, // 2: shipment.v1.Shipment.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 3: shipment.v1.ShipmentEvent.status:type_name -> shipment.v1.ShipmentStatus
	13, // 4: shipment.v1.ShipmentEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	1,  // 7: shipment.v1.ListShipmentsResponse.shipments:type_name -> shipment.v1.Shipment
	0,  // 8: shipment.v1.AddShipmentEventRequest.status:type_name -> shipment.v1.ShipmentStatus
	2,  // 9: shipment.v1.AddShipmentEventResponse.event:type_name -> shipment.v1.ShipmentEvent
	2,  // 10: shipment.v1.GetShipmentEventsResponse.events:type_name -> shipment.v1.ShipmentEvent
	...
	7,  // 13: shipment.v1.ShipmentService.ListShipments:input_type -> shipment.v1.ListShipmentsRequest
	9,  // 14: shipment.v1.ShipmentService.AddShipmentEvent:input_type -> shipment.v1.AddShipmentEventRequest
	11, // 15: shipment.v1.ShipmentService.GetShipmentEvents:input_type -> shipment.v1.GetShipmentEventsRequest
	...
	8,  // 18: shipment.v1.ShipmentService.ListShipments:output_type -> shipment.v1.ListShipmentsResponse
	10, // 19: shipment.v1.ShipmentService.AddShipmentEvent:output_type -> shipment.v1.AddShipmentEventResponse
	12, // 20: shipment.v1.ShipmentService.GetShipmentEvents:output_type -> shipment.v1.GetShipmentEventsResponse
